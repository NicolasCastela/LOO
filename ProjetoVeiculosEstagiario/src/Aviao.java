public class Aviao extends BaseVeiculo implements IImprimir {
    ...
    public Aviao(double pesoLiquido, int portas) {
        this.pesoLiquido = pesoLiquido;
        this.portas = portas;
    }
    ...
    public Aviao(int codigo, String nome, String modelo, String cor, String chassi, String placa, int anoModelo,
            ...
            int qtdeMotores, int qtdeOcupantes, double pesoLiquido, int portas) {
